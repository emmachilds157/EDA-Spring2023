...
> Answer: It is a factor class, which is not strictly numeric because the numbers correspond to a level that is comprised of characters, ie - active ingredient. So the numeric value is essentially a placeholder. 
