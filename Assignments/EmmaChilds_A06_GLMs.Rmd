...
```{r temperature.model}
#9
NTLbyALL.regression <- lm(data=NTL_Lake_ChemPhys_subset, temperature_C ~ depth + year4 + daynum + depth)
summary(NTLbyALL.regression)
#Depth and day number seem the best suited to predict temperature after running the AIC. 

#BUT, do we run step function?!?!?!
