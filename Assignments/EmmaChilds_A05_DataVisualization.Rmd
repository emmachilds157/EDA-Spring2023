...
#2 
str_today_NEON <- NEON.litter$collectDate
date_obj_today_NEON <- ymd(NEON.litter$collectDate)
date_obj_today_NEON
class(date_obj_today_NEON)

str_today_NTL <- NTL.Chem.Nutrients.PeterPaul$sampledate
date_obj_today_NLT <- ymd(NTL.Chem.Nutrients.PeterPaul$sampledate)
date_obj_today_NLT
class(date_obj_today_NLT)
```
## Define your theme
...
p1 <- ggplot(box_temps, aes(x=month, y=temperature_C)) + 
  geom_point()
p2 <- ggplot(box_TP, aes(x=month, y=tp_ug)) +
  geom_point()
p3 <- ggplot(box_TN, aes(x=month, y=tn_ug)) +
  geom_point()
