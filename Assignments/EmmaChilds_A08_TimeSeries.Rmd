...
GaringerOzone_2010s <- na.approx(GaringerOzone_new$Daily.Max.8.hour.Ozone.Concentration)
```
...
#GaringerOzone.monthly <- GaringerOzone_new %>%
  #mutate(GaringerOzone_new)
#pipe function mutate, then group by (Month, Year), then summarise
```
