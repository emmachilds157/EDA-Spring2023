...
```{r}
#3
EPAair.O3.NC2018$Date <- ymd(EPAair.O3.NC2018$Date)
EPAair.O3.NC2019$Date <- ymd(EPAair.O3.NC2019$Date)
EPAair.PM25.NC2018$Date <- ymd(EPAair.PM25.NC2018$Date)
EPAair.PM25.NC2019$Date <- ymd(EPAair.PM25.NC2019$Date)
#changing date columns to be date objects for all four datasets, using the 'lubridate' ymd function. 
