...
kable(x, format, digits = getOption("digits"), row.names = NA,
  col.names = "County","µg/m3", align, caption = NULL, label = NULL,
  format.args = list(), escape = TRUE, ...) #FINISH

#or this one below?

kable(summary_PM25,caption = "Mean Particulates (2.5mm)")
kable(summary_Ozone,caption = "Mean Ozone")
#And the column names should be "County" and "µg/m3" for both tables.
