...
```{r boxplots, echo=FALSE, fig.align='left', fig.height=2.5, fig.cap="Ozone Distribution by Month, 2018 & 2019"}

Ozone2018 <- epa_data %>%
  filter(Ozone & Year <= 2018) 

Ozone2019 <- epa_data %>%
  filter(Ozone & Year >= 2019) 
  
ggplot(data=Ozone2018, aes(x=Month,y=Ozone,color='lightblue')) +
