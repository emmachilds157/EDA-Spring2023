...
<<<<<<< HEAD
> Answer: It shows the loaded package, and any conflicts. 
=======
> Answer: 
>>>>>>> 1dffb1c (Add M3 (Data Exploration) lesson files)
...
<<<<<<< HEAD
> ANSWER: I found it in the metadata folder in the larger data folder, which I liked because I know I can always go to that folder to look for README files. The organization creates consistency, which I appreciate, and contributes to best practice. Anyone else would also know to look in that folder for any README file. 
=======
> ANSWER: 
>>>>>>> 1dffb1c (Add M3 (Data Exploration) lesson files)
...
<<<<<<< HEAD
> Answer: They are imported as NAs. 
=======
> Answer: 
>>>>>>> 1dffb1c (Add M3 (Data Exploration) lesson files)
...
<<<<<<< HEAD
> Answer: We never remove NAs for a time series analysis, but we might omit the NAs for....
=======
> Answer: 
>>>>>>> 1dffb1c (Add M3 (Data Exploration) lesson files)
