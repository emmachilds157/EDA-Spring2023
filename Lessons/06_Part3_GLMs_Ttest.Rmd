...
O3.onesample
#reject null hypothesis and accepting alternative
...
O3.twosample
#We will reject null hypothesis b/c p is less than 0.05

# Format as a GLM
O3.twosample2 <- lm(EPAair$Ozone ~ EPAair$Year)
summary(O3.twosample2)
#Have to change the question a little to make this work...is year a predictor of ozone levels? And yes, we see it is b/c of the p-value!
```
